...
import { check_location_validation, pushNotificationSchema } from '../../utils/validationSchemas.jsx';
                            ...
                            <div className="col-sm-12">
                                <div className="form-group row">
                                    ...
                                    <div className="col-sm-4">
                                        ...
                                        <input type="number" name="client_code" id="client_code" step="any" className="mt-0 mb-3 fs-13 form-control length_count" placeholder="client_code" value={values.client_code} onChange={handleChange}/>
