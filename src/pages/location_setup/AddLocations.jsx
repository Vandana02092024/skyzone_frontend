...
export default function AddLocations() {
    ...
    const onSubmit = async (values) => {
        ...
        const response = await apiRequest( {url: ADDLOCATIONMANAGERS, method: "POST", data: formData});
        if (response) {
             messagePop(response);
            resetForm();
        }
                                ...
                                <form  onSubmit={handleSubmit}>
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-4">
                                            ...
                                            <input type="number" name="client_code" id="client_code" step="any" className="mt-0 mb-3 fs-13 form-control length_count" placeholder="client_code" value={values.client_code} onChange={handleChange} onBlur={handleBlur}/>
                                        ...
                                        <div className="col-sm-4">
                                            ...
                                            <input type="email" name="client_email" id="client_email" className="mt-0 mb-3 fs-13 form-control length_count" placeholder="client_email" value={values.client_email} onChange={handleChange} onBlur={handleBlur}/>
                                        ...
                                        <div className="col-sm-4">
                                            ...
                                            <input type="email" name="order_email" id="order_email" className="mt-0 mb-3 fs-13 form-control length_count" placeholder="order_email" value={values.order_email} onChange={handleChange} onBlur={handleBlur}/>
                                        ...
                                        <div className="col-sm-4">
                                            ...
                                            <input type="email" name="reply_to" id="reply_to" className="mt-0 mb-3 fs-13 form-control length_count" placeholder="reply_to" value={values.reply_to} onChange={handleChange} onBlur={handleBlur}/>
